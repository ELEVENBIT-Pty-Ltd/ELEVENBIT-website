      ...
      <div className="footer-content">
        <div className="footer-main">
          <div className="footer-about" ref={aboutRef}>
            ...
            <p>
              We create innovative digital solutions that help businesses thrive in today's competitive landscape. Our
              team of experts combines technical excellence with creative thinking to deliver exceptional results that
              exceed expectations.
            </p>
