          ...
          <div className="faq-grid">
            <div className="faq-item">
              ...
              <p>
                ...
                digital marketing, UI/UX design, cloud solutions, and AI integration.
              </p>
            </div>
            <div className="faq-item">
              ...
              <p>
                ...
                complex application could take 3-6 months. We'll provide a detailed timeline during our initial
                consultation.
              </p>
            </div>
            <div className="faq-item">
              ...
              <p>
                Yes, we offer various maintenance and support packages to ensure your digital products continue to
                perform optimally after launch. Our team is always available to address any issues or implement updates.
              </p>
            </div>
            <div className="faq-item">
              <h3>How do we get started?</h3>
              <p>
                Simply fill out the contact form on this page or give us a call. We'll schedule an initial consultation
                to discuss your project requirements, goals, and timeline before providing a detailed proposal.
              </p>
            </div>
          </div>
        </div>
